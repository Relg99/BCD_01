...
FINAL_IMAGE=${DISTDIR}/BCD_01.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=BCD_01.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/BCD_01.o
POSSIBLE_DEPFILES=${OBJECTDIR}/BCD_01.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/BCD_01.o

# Source Files
SOURCEFILES=BCD_01.s
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/BCD_01.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC16F628A
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/BCD_01.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/BCD_01.o: BCD_01.s  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/BCD_01.o 
	${MP_AS} -mcpu=PIC16F628A -c \
	-o ${OBJECTDIR}/BCD_01.o \
	BCD_01.s \
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/BCD_01.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC16F628A ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/BCD_01.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
